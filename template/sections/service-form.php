    ...
    <div class="service-form-card__body">
        ...
        <div>
            <p class="service-form-card__title">
                <?= $serviceId == '2'
                    ? 'Оставьте заявку, чтобы получить <strong>индивидуальное коммерческое предложение</strong>'
        ...
        <div class="modal-content__body">
            ...
            <div class="footer__social">
                <div>
                    ...
                    <a href="https://wa.me/74951978288" class="hidden wow fadeIn" data-wow-delay="0.2s"
