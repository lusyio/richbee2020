...
$bgUnderBody = '#0a0b11';
$palitra = ['','#D29C6A','#3A3A3A','#f25e30','#F8AC53','#40866E','#d2232a','#3768b4','#5156d8','#202c6f','#0088FF','#1e46f3','#E84323','','#e3337e','#1E4ECB','#86BC6A','#005896','#1b53f4','#fdd900','#ffbd00','#fcb602','#004157','#b23427'];
    ...
    <div class="section-case" id="caseSection">
        ...
        <div class="section-case__body">
            <div class="section-case__info">
                ...
                <?php endif; ?>
                <?php if(empty($caseUrl) && empty($casePdf)) : ;?>
