                        ...
                        <div class="swiper-slide">
                            <div class="reviews-slider__item">
                                ...
                                <div class="reviews-slider__content">
                                    ...
                                    <p>
                                        Но за сайтами других писателей с тех пор следила. Чаще всего они мне не нравились, но кое-какие я для себя отмечала. Например, сайт Александры Черчень. Дизайн там мне не по душе, но удобство я оценила и на всякий случай запомнила разработчика…<a href="#">Читать полный отзыв в VK</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="reviews-slider__item">
                                ...
                                <div class="reviews-slider__content">
                                    <div class="reviews-slider__content-topline">
                                        ...
                                        <a class="reviews-slider__content-link" href="/case/wordpress-reader/">Посмотреть кейс</a>
                                    </div>
                                    <h3 class="reviews-slider__content-subtitle">Писательница</h3>
                                    <p>
