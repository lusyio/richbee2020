...
<section class="mainBlock serviceInfo">
    <div class="container">
        <h1 class="hero__title">Разработка сайтов, интернет-магазинов и сервисов</h1>
        <p class="hero__text">
                ...
                <div id="reviews-slider" class="swiper-container reviews-slider">
                    ...
                    <div class="swiper-slide">
                        <div class="reviews-slider__item">
                            ...
                            <p>
                                Первая моя попытка создать свой сайт с треском провалилась. Помню, я повелась на рекламу Wix — конструктор сайтов. Что-то там на коленке сама сделала, но быстро поняла: дизайн — не моё. Плюс организовать электронные продажи Wix раньше не мог.
                            Так что я надолго запомнила: сайт — это громоздко, трудоёмко, энергозатратно и весьма денежно. А ещё с тех пор я на дух не переношу конструкторы сайтов.
                            </p>
                            <p>
                                Но за сайтами других писателей с тех пор следила. Чаще всего они мне не нравились, но кое-какие я для себя отмечала. Например, сайт Александры Черчень. Дизайн там мне не по душе, но удобство я оценила и на всякий случай запомнила разработчика. Затем был сайт Марины Эльденберт — той же студии, но с совсем другим дизайном. Тут я присмотрелась внимательнее. Тот же разработчик, значит, коллеги ему верят?...<a href="#">Читать полный отзыв в VK</a>
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
