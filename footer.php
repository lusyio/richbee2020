    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="footer-top__contact">
                <a class="footer-top__email" href="mail:sales@richbee.ru" title="Напишите нам на почту">sales@richbee.ru</a>
                <a class="footer-top__phone" href="#" title="Позвоните нам">8 (495) 312-12-12</a>
                
                <ul class="footer-top__social-list">
                    <li>
                        <a href="#" title="Страничка Richbee в VK">
                            <svg version="1.1" id="Layer_1" fill="#fff" width="30px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455 455" style="enable-background:new 0 0 455 455;" xml:space="preserve">
                    ...
                    <li>
                        <a href="#" title="Аккаунт Richbee в Instagram">
                            ...
                            <svg version="1.1" id="Layer_1" width="30px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 364 364" fill="#fff" style="enable-background:new 0 0 364 364;" xml:space="preserve">
                                <g>
                    ...
                    <li>
                        <a href="#" title="Напишите нам в Telegram">
                            ...
                            <svg version="1.1" width="30px" fill="#fff" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455 455" style="enable-background:new 0 0 455 455;" xml:space="preserve">
                                <g>
		...
		C318.739,149.061,316.115,145.614,313.567,147.179z" />
                    ...
                    <li>
                        <a href="#" title="Напишите нам в Whatsapp">
                            <svg version="1.1" id="Capa_1" width="30px" fill="#fff" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455.731 455.731" style="enable-background:new 0 0 455.731 455.731;" xml:space="preserve">
                                <g>
