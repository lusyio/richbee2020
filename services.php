        ...
        <section class="service">
            <div class="container">
                <div class="service-block" id="digital">
                    ...
                    <p class="service-block__subtitle wow fadeInUp" data-wow-delay="0.1s">Хватит кормить Билла и вести
                        дела в Эксельке! Объедините все бизнес-процессы в единую систему управления с удобным
                        интерфейсом</p>
                ...
                <div class="service-block" id="develop">
                    ...
                    <p class="service-block__subtitle wow fadeInUp" data-wow-delay="0.1s">Веб-разработка
                        интернет-проектов любой сложности под ключ.<br>2-х месячная гарантия на исправление любых багов
                        после сдачи проекта</p>
                    <div class="service-block__list">
                        <?php
                        // сайт, им, сервисы
                        $services = [1, 2, 6, 8];
                ...
                <div class="service-block" id="support">
                    ...
                    <p class="service-block__subtitle wow fadeInUp" data-wow-delay="0.1s">Постоянная поддержка вашего
                        продукта нашимим специалистами. Контроль за работоспособностью и доработка нового
                        функционала</p>
                    <div class="service-block__list">
                        <?php
                        // тех.обс, доработка
